...
# model_class_glmnet_tuning <- ___________________(
#   ___________________ , df_clas,
#   tuneGrid = ___________________(___________________,
#                          ______________________________________),
#   method = ___________________,
#   trControl = ___________________
# )
# 
...
```{r}
# model_clas_xgbTree <- ___________________(___________________ , df_clas,
#                             method = ___________________,
#                             trControl=___________________)
...
# summary(___________________, metric="ROC")
# 
# # GENIAL PARA VER COMPARATIVA DE MANERA VISUAL
# bwplot(___________________, metric = "ROC") # display univariate visualizations of the resampling distributions
# dotplot(___________________, metric="ROC")
