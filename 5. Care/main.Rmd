...
model_class_glmnet_tuning <- train(Status_E2_C3~ ., df_clas, tuneGrid=tune_grid # nolint
...
```{r}
model_class_xgb_tree <- train(Status_E2_C3~ ., df_clas, method = "xgbTree", trControl=my_control_class) # nolint

model_class_xgb_tree
```
